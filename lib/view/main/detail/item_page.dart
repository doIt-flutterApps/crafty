...
class _ItemPage extends State<ItemPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(widget.selectedPost.title)),
        ...
        child: Column(
          children: [
                ...
                children: [
                  widget.selectedPost.image != ''
                      ? SizedBox(
                        ...
                        width: MediaQuery.of(context).size.width,
                        child: Hero(
                          tag: widget.selectedPost.timestamp,
                          child: Image.network(
                            widget.selectedPost.image,
                            fit: BoxFit.cover,
                          ),
                  ...
                  SizedBox(height: 10),
                  Text(
                    widget.selectedPost.content,
                    style: TextStyle(fontSize: 20),
                  ),
                  SizedBox(height: 10),
                  Text(
                    '${widget.selectedPost.price}원',
                  ...
                  SizedBox(height: 10),
                  Text(
                    widget.selectedPost.timestamp.toDate().toString().substring(
                      0,
                      16,
                    ),
            ...
            ElevatedButton(
              ...
              child: Text(
                user.email == widget.selectedPost.user
                    ? '나에게 온 대화 보기'
                    : '말걸어 보기',
              ),
            ),
